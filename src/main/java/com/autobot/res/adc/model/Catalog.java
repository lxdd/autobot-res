...
public class Catalog {
	...
	public String toString() {
		return "Catalog [id=" + id + ", parentId=" + parentId + ", serveId=" + serveId + ", url=" + url + ", gmtCreate="
				+ gmtCreate + ", nameCreate=" + nameCreate + ", gmtModified=" + gmtModified + ", nameModified="
				+ nameModified + ", isDeleted=" + isDeleted + "]";
	}
